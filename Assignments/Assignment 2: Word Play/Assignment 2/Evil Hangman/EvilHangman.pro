...
DISTFILES += \
    res/1984.txt \
    res/DrSeuss-Analyzed.txt \
    res/DrSeuss.txt \
    res/Emoticons-Analyzed.txt \
    res/Emoticons.txt \
    res/Hi-Analyzed.txt \
    res/Hi.txt \
    res/JaneEyre-Analyzed.txt \
    res/JaneEyre.txt \
    res/JFK-Berlin-Analyzed.txt \
    res/JFK-Berlin.txt \
    res/Middlemarch-Analyzed.txt \
    res/Middlemarch.txt \
    res/MLK-Dream-Analyzed.txt \
    res/MLK-Dream.txt \
    res/OldMacDonald-Analyzed.txt \
    res/OldMacDonald.txt \
    res/Preamble-Constitution-Analyzed.txt \
    res/Preamble-Constitution.txt \
    res/RosesAreRed-Analyzed.txt \
    res/RosesAreRed.txt \
    res/TaleOfTwoCities-Analyzed.txt \
    res/TaleOfTwoCities.txt \
    res/TomSawyer-Analyzed.txt \
    res/TomSawyer.txt \
    res/US-Constitution-Analyzed.txt \
    res/US-Constitution.txt \
    res/Obama-Farewell.txt \
    res/Obama-Farewell.txt.analyzed \
    res/GreenEggsAndHam.txt.analyzed
